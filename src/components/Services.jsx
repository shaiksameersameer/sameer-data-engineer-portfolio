      ...
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        <div data-aos="fade-up" className="md:absolute top-10 left-0 md:w-[450px] z-20 mb-16 md:mb-0">
          ...
          <p className="text-gray-500 text-base md:text-lg max-w-sm font-medium leading-relaxed">
            I design and build modern data pipelines using AWS, PySpark, Apache Airflow, SQL and Data Warehousing technologies.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <TagCard 
            ...
            text="Collect and ingest structured and unstructured data from multiple sources using AWS S3 and ETL pipelines."
          ...
          <TagCard 
            ...
            text="Transform raw datasets using PySpark and SQL to create clean, reliable and analytics-ready data."
          ...
          <TagCard 
            ...
            text="Automate ETL workflows using Apache Airflow for scheduling, monitoring and orchestration."
          ...
          <TagCard 
            ...
            text="Store and analyze data using Redshift and build dashboards to generate business insights."
